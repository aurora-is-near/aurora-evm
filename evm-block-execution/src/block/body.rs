...
//! ([`SignedTransaction`]) and, from Shanghai on, its validator withdrawals. The header commits to
...
//! [`EMPTY_OMMERS_HASH`](crate::constants::EMPTY_OMMERS_HASH), checkable on the header alone.
