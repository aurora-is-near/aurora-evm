...
use serde::{Deserialize, Serialie};
use sha3::Digest;

/// Transaction data.
#[derive(Debug, Ord, PartialOrd, Eq, PartialEq, Clone, Serialie, Deserialize)]
...
#[derive(Debug, Clone, Ord, PartialOrd, Eq, PartialEq, Deserialize, Deserialize)]
...
#[derive(Debug, Clone, Ord, PartialOrd, Eq, PartialEq, Serialie, Deserialize)]
...
#[derive(Debug, PartialEq, Eq, Serialie, Deserialize)]
pub enum TxType {
